...
public:
	...
	static std::string BuildJointMatJson(const Eigen::MatrixXd& joint_mat, cBVHReader *r);
	static std::string BuildJointJson(int id, const tJointDesc& joint_desc, cBVHReader *r);
